...
export class CarritoPage  {
  ...
  mostrarTarjetas() {
    ...
    return this.http.post("http://ec2-54-193-34-153.us-west-1.compute.amazonaws.com:5011/api/card/get",customer_id,httpOptions).subscribe(
      data => {
  ...
  AddCargo(){
    ...
    return this.http.post("http://ec2-54-193-34-153.us-west-1.compute.amazonaws.com:5011/api/charge/add",JSON.stringify(this.ChargeRequest),httpOptions).subscribe(
      data => {
